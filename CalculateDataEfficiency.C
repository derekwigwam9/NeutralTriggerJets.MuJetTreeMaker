...
static const TString sTreeDefault("Gfmtodst");
static const TString sInputDefault("../../ThirdJetMaker/output/merged/pt5.thirdmaker.root");
static const TString sOutputDefault("pp200r9pt5u.default.root");



void CalculateDataEfficiency(UInt_t &nTrgPi0, UInt_t &nTrgGam, const Bool_t isInBatchMode=false, const Bool_t isDetectorLevel=false, const Bool_t isTriggered=false, const TString sInput=sInputDefault, const TString sTree=sTreeDefault, const TString sOutput=sOutputDefault) {
